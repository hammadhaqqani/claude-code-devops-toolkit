# DevOps Migration Prompts

This document contains curated prompts for migration infrastructure, deployments, and configuration issues using Claude Code.

## Infrastructure Migration

### Terraform Migration

#### Basic Migration Prompt
...
**Error Log:**
[Relevant error output from Actions]
...
### General Migration Prompt Template

```
I need help migration [issue type]:
...
1. **Initial Diagnosis:**
   ```
   I'm seeing [error]. Here's the configuration and error message. 
   What's causing this?
   ```
